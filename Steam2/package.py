...
# Embedded file name: Y:\source\Server\Steam2\package.py
import struct, zlib
...
class Package(object):
    ...
    def put_file(self, filename, filedata):
        chunks = []
        for i in xrange(0, len(filedata), 32768):
            chunks.append(zlib.compress(filedata[i:i + 32768], self.compress_level))
